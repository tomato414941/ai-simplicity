...
export async function app(t, handler, options = {}) {
  ...
  if (options.foundation) options.foundation.keys = { read: async (id) => foundationKeys.get(id) ?? null, write: async (id, keyId) => foundationKeys.set(id, keyId) };
  const responses = new UserResponses({ ...configuration, billing, tools: options.foundation?.enabled ? [options.foundation] : [], store: options.responseStore ?? {
